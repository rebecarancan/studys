...
class AdressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adress" do
    assert_difference('Adress.count') do
      post adresses_url, params: { adress: { city: @adress.city, contact_id: @adress.contact_id, state: @adress.state, street: @adress.street } }
    end
  ...
  test "should update adress" do
    patch adress_url(@adress), params: { adress: { city: @adress.city, contact_id: @adress.contact_id, state: @adress.state, street: @adress.street } }
